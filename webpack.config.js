...
// injects your bundled JS (bundle.js) into an HTML file
// without this, you’d have to manually include
...
export default {
    ...
    output: {
        ...
        filename: "bundle.js",
        clean: true,
        // cleans/deletes old files in dist/ before each new build, 
        // so you don’t get outdated bundles.
    },
    ...
    resolve: {
        extensions: [".js", ".jsx"], // import modules without extensions
    },
    ...
    plugins: [
        new HtmlWebpackPlugin({
            ...
            // a plugin that injects bundle script (<script src="bundle.js">) 
